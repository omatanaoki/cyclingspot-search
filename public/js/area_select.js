window.onload = function() {
    var area_options = document.getElementById("submit_area").options;
    var area = document.getElementById('area_name').value;
    
    for (var i=0; i < area_options.length; i++) {
        if (area_options[i].value === area) {
            area_options[i].selected = true;
        }
    }
    var $city =$('.city');
    ...
    var city_options = document.getElementById("submit_city").options;
    var city = document.getElementById('city_name').value;
    for (var i=0; i < city_options.length; i++) {
        if (city_options[i].value === city) {
            city_options[i].selected = true;
        }
    }
};
